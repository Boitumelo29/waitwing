...
abstract class AppLocalizations {
  ...
  /// No description provided for @waitWing.
  ///
  /// In en, this message translates to:
  /// **'Wait Wing'**
  String get waitWing;

  /// No description provided for @waitWingSub.
  ///
  /// In en, this message translates to:
  /// **'Queuing made simple.'**
  String get waitWingSub;

  /// No description provided for @waitWingQueueSystem.
  ///
  /// In en, this message translates to:
  /// **'Wait Wing Queue System.'**
  String get waitWingQueueSystem;
  ...
  /// No description provided for @pickPic.
  ///
  /// In en, this message translates to:
  /// **'Pick a picture'**
  String get pickPic;
